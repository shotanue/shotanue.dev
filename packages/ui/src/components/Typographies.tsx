...
export const Heading4 = ({ children, className }: ComponentProps<"h4">) => <h4 className={classNames(className, "text-xl font-bold")}>{children}</h4>;

export const Paragraph = ({ children, className }: ComponentProps<"p">) => <p className={classNames(className, "text-base")}>{children}</p>;

export const Label = ({ children, className }: ComponentProps<"span">) => <span className={classNames(className, "text-sm")}>{children}</span>;
